...
void cordiccart2pol(data_t x, data_t y, data_t * r,  data_t * theta)
{
  ...
  for (int i = 0; i < NO_ITER; i++){
    data_t s = Kvalues[i];
    data_t denom = data_t(1) + s * s;
    data_t invsqrt = hls::rsqrt(denom);
    K_cum *= invsqrt;
  }
